...
<!-- google place auto complete work -->
  <style>
    .pac-container{
        z-index:9999;
    }
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="{{asset("images/shop.png")}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Subway Dashboard</span>
    </a>
...
<script>
  ...
  <!--Google Map APIS -->
<script src="http://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBdQPTMiJRn8DaTSh2UruphoV4FF1_PVSk
"></script>
  <script>
    $(function () {
