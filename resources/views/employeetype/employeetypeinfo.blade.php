              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr>
                      ...
                      <td>0 min</td>
                      <td>
                        <button type="button" class="btn btn-primary btn-xs editmodal"  id=""><span class="fa fa-edit"></span> Edit</button>
                        <button type="button" class="btn btn-danger btn-xs deletemodal" id=""><span class="fa fa-trash"></span> Delete</button>
                      </td>
                    </tr>
                </tbody>
                <tfoot>
              ...
              <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="txtshift_late" id="txtshift_late" class="form-control" value="{{old('txtshift_late')}}" placeholder="Enter Employee Address">
                    </div>
                  </div>
              </div>   
            </div>
